...
f1:
	...
	$(EMCC) source/console.cpp source/indexed_db.cpp f1l3/f1l3b.c  -o build/public_html/js/f1b.js --post-js f1l3/post-b.js
	$(EMCC) f1l3/f1l3c.c source/console.cpp source/indexed_db.cpp -o build/public_html/js/f1c.js --post-js f1l3/post-c.js
	$(EMCC) f1l3/f1l3d.c source/console.cpp source/indexed_db.cpp -o build/public_html/js/f1d.js --post-js f1l3/post-d.js
	$(EMCC) f1l3/f1l3e.c source/console.cpp source/indexed_db.cpp -o build/public_html/js/f1e.js --post-js f1l3/post-e.js
