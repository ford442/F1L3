...
all:
	...
	$(EMCCC) f1l3/f1l3f.c -o build/public_html/js/ff.js --extern-post-js index.js --post-js f1l3/filesys.js --post-js f1l3/ccall.js --post-js f1l3/fs-glsl.js -ffast-math -sENVIRONMENT=web -sINITIAL_MEMORY=128mb -sALLOW_MEMORY_GROWTH=0 -O3 -sMALLOC="emmalloc" -sUSES_DYNAMIC_ALLOC=0 -sSUPPORT_LONGJMP=0 -sFORCE_FILESYSTEM=1 -sSINGLE_FILE=0 -lidbfs.js -g2 -flto=thin --closure 1
