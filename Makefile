...
all:
	...
	-sFORCE_FILESYSTEM=1 -lidbfs.js -sSINGLE_FILE=1 --post-js f1l3/post-f.js 
	
	$(EMCC) f1l3/f1l3b.c source/console.cpp source/indexed_db.cpp --post-js f1l3/post-b.js -o build/public_html/js/fb.js
	$(EMCC) f1l3/f1l3c.c source/console.cpp source/indexed_db.cpp --post-js f1l3/post-c.js -o build/public_html/js/fc.js
	$(EMCC) f1l3/f1l3d.c source/console.cpp source/indexed_db.cpp --post-js f1l3/post-d.js -o build/public_html/js/fd.js
	$(EMCC) f1l3/f1l3e.c source/console.cpp source/indexed_db.cpp --post-js f1l3/post-e.js -o build/public_html/js/fe.js
	...
	--post-js f1l3/filesys.js -std=c++20 --post-js f1l3/ccall.js \
