...
all:
	...
	$(EMCC) source/console.cpp source/indexed_db.cpp f1l3/f1l3b.c -sEXPORTED_FUNCTIONS="["_main","_php00","_php00st"]" -sEXPORTED_RUNTIME_METHODS="["ccall"]" -o build/public_html/js/fb.js 
