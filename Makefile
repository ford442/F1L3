EMCC = em++ -O3 --closure 0 -ffast-math --bind -Iinclude -sENVIRONMENT=web -sINITIAL_MEMORY=128mb \
-s ALLOW_MEMORY_GROWTH=0 -sMALLOC="emmalloc" -sSUPPORT_LONGJMP=0 -sFORCE_FILESYSTEM=1 -lidbfs.js -flto=thin \
-sSINGLE_FILE=1
EMCCC = em++

all:
	$(EMCCC) f1l3/f1l3a.c -o build/public_html/js/fa.js -ffast-math -sENVIRONMENT=web \
	-sINITIAL_MEMORY=128mb -sALLOW_MEMORY_GROWTH=0 -O3 -sMALLOC="emmalloc" -sUSES_DYNAMIC_ALLOC=0 \
	...
	-sEXPORTED_FUNCTIONS='["_main","_str","_pl"]' -sEXPORTED_RUNTIME_METHODS=ccall \
	...
	-sFORCE_FILESYSTEM=1 -sGL_TESTING=1 -sFULL_ES2=1 -sFULL_ES3=1 -sSINGLE_FILE=0 -sMAX_WEBGL_VERSION=2 -sMIN_WEBGL_VERSION=2 -lidbfs.js -flto=thin --closure 0 -sUSE_SDL=2
